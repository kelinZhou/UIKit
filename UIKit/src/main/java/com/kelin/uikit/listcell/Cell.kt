...
interface Cell : LayoutContainer {
    ...
    fun onCreate(owner: CellOwner)

    fun bindData(owner: CellOwner)
    ...
    fun onViewAttachedToWindow(owner: CellOwner, position: Int)

    fun onViewDetachedFromWindow(owner: CellOwner, position: Int)
