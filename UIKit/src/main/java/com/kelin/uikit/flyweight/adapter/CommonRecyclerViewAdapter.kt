 ...
 * **版本:** v 1.0.0
 */
class CommonRecyclerViewAdapter<T, VH> constructor(
    private val typeTranslator: ItemTypeTranslator<T>,
    holderGenerator: ItemHolderGenerator<out VH, T>,
    itemEventListener: OnItemEventListener<T>,
    noMoreDataHandler: NoMoreDataHandler = DefNoMoreDataHandler()
) : SuperRecyclerViewAdapter<T, VH>(itemEventListener, noMoreDataHandler) where VH : RecyclerView.ViewHolder, VH : SuperRecyclerViewAdapter.ItemViewHolderInterface<T> {
    ...
    private class DefNoMoreDataHandler : NoMoreDataHandler {
